...
print("Inerita change to wing on xy plane: ixx iyy izz ixy ixz iyz", total_rotate @ np.array([[test_wing.I[0], test_wing.I[3], test_wing.I[4]], [test_wing.I[3], test_wing.I[1], test_wing.I[5]], [test_wing.I[4], test_wing.I[5], test_wing.I[2]]]) @ total_rotate.T)
