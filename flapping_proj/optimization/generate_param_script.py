...
# )
test_wing = wing_classes.ThreeSegmentWing( #larger with area
0.2,#     wing_length: float,
0.01,#     root_edge: float,
0,#     gap_size: float,
50 / 180 * np.pi,#     spar_angle_0: float,
0.08,#     spar_length_0: float,
40 / 180 * np.pi,#     spar_angle_1: float,
0.06#     spar_length_1: float
)
...
print("Blade Areas: ", ', '.join(map(str,blade_areas)))
